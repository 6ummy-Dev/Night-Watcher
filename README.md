...
- **Progress.** One donut chart — the chosen ordering's, and it follows the belt: universes, eras of Bruce's life, or decades of release — where each slice is sized by its share of the catalogue and fills as you watch. Tap any slice to jump straight there; the fold lists below carry the same jumps for all three orderings.
...
trusted. That evidence lives in `qa/negative/` — 45 negative suites, 664
