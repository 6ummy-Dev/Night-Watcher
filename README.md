...
- **A weight budget** — *guarded.* `docs/index.html` must stay under 150 KB raw and 50 KB gzipped; it is currently 128 KB / 41 KB. A single file that opens instantly is the whole premise, and arithmetic is the only thing protecting it.
